...
//     projectBox[i].style = "background:#8d99ae"
//     projectName[i].style = "color:#2b2d42";
//   })
//   projectBox[i].addEventListener('mouseout', () => {
//     projectBox[i].style = "background:#2b2d42";
//     projectName[i].style = "color:#fcf6ea";
//   })
// }
